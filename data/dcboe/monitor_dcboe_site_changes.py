...
def poll_dcboe():
    ...
    current_link_text = (
        '<p><a href="/dcboe/media/PDFFiles/Copy-of-List-of-Advisory-Neighborhood-Commissioners_2020-(00000004).pdf">ANC Candidate List for the November 3 General Election</a></p>'
        )
