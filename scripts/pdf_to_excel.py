...
input_pdf = Path('~/Dropbox/OpenANC/DCBOE candidate lists 2024/General-24-ANC-Candidates-08082024.pdf')
output_xlsx = Path('data/dcboe/excel-clean/dcboe-ballot-2024-08-08.xlsx')
