...
input_pdf = Path('~/Dropbox/OpenANC/DCBOE candidate lists 2024/General-24-ANC-Candidates-08022024b.pdf')
output_xlsx = Path('data/dcboe/excel-clean/dcboe-ballot-2024-08-02.xlsx')
